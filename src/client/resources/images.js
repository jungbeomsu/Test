...
export const arrowDown = <img style={{width: "16px", height: "16px"}} src={require("../images/v1/arrow_down_gray.png").default}/>;
export const groupChatting = <img style={{width: "28px", height: "28px"}} src={require("../images/v1/chatting/bold.png").default}/>;
export const closeButtonG = <img style={{width: "16px", height: "16px"}} src={require("../images/v1/close_button_gray.png").default}/>;
